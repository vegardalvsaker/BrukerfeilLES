...
public class LearningGoalDb extends Database {
    ...
    private static final String goalQuery = "select learn_goal_text, learn_goal_points from LearningGoal where module_id = ?";
    private static final String moduleInfoQuery = "select * from Module where module_id = ?";
